...
class PetRegistrationController extends Controller
{
    ...
    {
        $pet_registration->update(['status' => 'registered', 'denial_reason' => null]);
     ...
     */
    public function deny(Request $request, PetRegistration $pet_registration)
    {
