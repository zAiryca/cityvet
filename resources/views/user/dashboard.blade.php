...
<div class="max-w-7xl mx-auto py-6 px-4">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        <div class="bg-green-50 p-6 rounded-lg shadow">
            ...
            <p class="text-3xl font-bold">{{ auth()->user()->adoptedPets()->count() }}</p>
            <a href="{{ route('profile.edit') }}" class="text-green-600 hover:underline">View Adopted</a>
        </div>
        <div class="bg-blue-50 p-6 rounded-lg shadow">
            <h3 class="text-lg font-semibold text-blue-800">Claimed Pets</h3>
            <p class="text-3xl font-bold">{{ auth()->user()->claimedPets()->count() }}</p>
            <a href="{{ route('profile.edit') }}" class="text-blue-600 hover:underline">View Claimed</a>
        </div>
        <div class="bg-purple-50 p-6 rounded-lg shadow">
            <h3 class="text-lg font-semibold text-purple-800">Event Registrations</h3>
            <p class="text-3xl font-bold">{{ auth()->user()->eventRegistrations()->count() }}</p>
            <a href="{{ route('events.index') }}" class="text-purple-600 hover:underline">View Events</a>
        </div>
    ...
    <div class="bg-white p-6 rounded-lg shadow">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <a href="{{ route('profile.edit') }}" class="bg-blue-600 text-white p-4 rounded text-center hover:bg-blue-700">Profile & Pets</a>
