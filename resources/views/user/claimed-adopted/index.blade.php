    ...
    <div class="px-4 py-8 mx-auto max-w-7xl">
        ...
        <div class="flex flex-col gap-4 mb-8 sm:flex-row sm:items-center sm:justify-between">
            <div class="flex items-center">
                <div class="p-3 mr-4 bg-white rounded-full shadow-sm flex-shrink-0">
        ...
        <div class="mb-6 bg-white shadow-sm rounded-2xl overflow-x-auto">
            <div class="flex p-2 space-x-1 min-w-max">
                <a href="{{ route('user.adopted-claimed-pets') }}"
                   class="px-4 py-2 rounded-lg text-sm font-medium transition-all duration-200 whitespace-nowrap {{ empty($tab) ? 'bg-blue-50 text-gray-800 shadow-sm' : 'text-gray-600 hover:bg-gray-50' }}">
                    All Pets
                </a>
                <a href="{{ route('user.adopted-claimed-pets', ['tab' => 'adopted']) }}"
                   class="px-4 py-2 rounded-lg text-sm font-medium transition-all duration-200 whitespace-nowrap {{ ($tab === 'adopted') ? 'bg-green-50 text-gray-800 shadow-sm' : 'text-gray-600 hover:bg-gray-50' }}">
                    ✓ Adopted
                </a>
                <a href="{{ route('user.adopted-claimed-pets', ['tab' => 'claimed']) }}"
                   class="px-4 py-2 rounded-lg text-sm font-medium transition-all duration-200 whitespace-nowrap {{ ($tab === 'claimed') ? 'bg-blue-50 text-gray-800 shadow-sm' : 'text-gray-600 hover:bg-gray-50' }}">
                    ✓ Claimed
                </a>
            </div>
        </div>
