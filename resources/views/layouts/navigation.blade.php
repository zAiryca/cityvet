        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="flex items-center shrink-0">
                    <a href="{{ route('home') }}">
                        <img src="{{ asset('images/alaminos-logo.png') }}" alt="Alaminos City Veterinary Office Logo" class="block w-auto h-9">
                    </a>
                </div>
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <div class="flex items-center space-x-2">
                    <a href="{{ route('lang.switch', 'en') }}" class="text-sm text-gray-700 hover:text-gray-900 {{ app()->getLocale() === 'en' ? 'font-bold' : '' }}">EN</a>
                    <span class="text-gray-400">|</span>
                    <a href="{{ route('lang.switch', 'fil') }}" class="text-sm text-gray-700 hover:text-gray-900 {{ app()->getLocale() === 'fil' ? 'font-bold' : '' }}">FIL</a>
                </div>
            </div>
