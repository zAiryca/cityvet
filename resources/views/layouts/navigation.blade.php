        ...
        <div class="flex items-center justify-between h-20">
            ...
            <div class="hidden lg:flex lg:items-center lg:justify-center lg:flex-1 lg:space-x-1">
                <x-nav-link :href="route('home')" :active="request()->routeIs('home')"
                    ...
                    <svg class="flex-shrink-0 w-4 h-4 mr-1.5" xmlns="http://www.w3.org/2000/svg" fill="none"
                ...
                <x-nav-link :href="route('pets.impounded')" :active="request()->routeIs('pets.impounded')"
                    ...
                    <svg class="flex-shrink-0 w-4 h-4 mr-1.5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                        <path fill="#ffffff"
            ...
            <div class="hidden lg:flex lg:items-center lg:gap-3">
                @guest
                    <!-- Login Button -->
                    <a href="{{ route('login') }}"
                        class="inline-flex items-center px-5 py-2.5 text-base font-bold text-gray-900 transition duration-150 ease-in-out bg-white border-2 border-white rounded-lg shadow-lg hover:bg-gray-100 hover:shadow-xl transform hover:-translate-y-0.5">
                    ...
                    <x-dropdown align="right" width="48">
                        <x-slot name="trigger">
                            <button
                                ...
                                <svg class="flex-shrink-0 w-4 h-4 ml-2" xmlns="http://www.w3.org/2000/svg" fill="none"
                                    viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M19 9l-7 7-7-7" />
                                </svg>
                        ...
                        <x-slot name="content">
                            <div
                                class="border border-pink-200 shadow-lg bg-gradient-to-br from-pink-50 to-purple-50 rounded-xl">
            ...
            <div class="flex items-center lg:hidden">
                <button @click="open = ! open"
                    class="inline-flex items-center justify-center p-3 text-white transition duration-150 ease-in-out rounded-lg hover:text-gray-300 hover:bg-gray-800 focus:outline-none">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden bg-gray-900 border-t border-gray-800 lg:hidden">
        <div class="px-4 pt-4 pb-3 space-y-2">
            <x-responsive-nav-link :href="route('home')" :active="request()->routeIs('home')"
                ...
                <svg class="flex-shrink-0 w-5 h-5 mr-3" xmlns="http://www.w3.org/2000/svg" fill="none"
                    viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
                </svg>Home
            ...
            <x-responsive-nav-link :href="route('pets.impounded')" :active="request()->routeIs('pets.impounded')"
                class="px-4 py-3 text-base font-semibold text-white transition-colors rounded-lg hover:text-gray-300 hover:bg-gray-800">
                <svg class="flex-shrink-0 w-5 h-5 mr-3" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                    <path
                        d="M234.5 92.9c14.3 42.9-.3 86.2-32.6 96.8s-70.1-15.6-84.4-58.5 .3-86.2 32.6-96.8 70.1 15.6 84.4 58.5zM100.4 198.6c18.9 32.4 14.3 70.1-10.2 84.1s-59.7-.9-78.5-33.3-14.3-70.1 10.2-84.1 59.7 .9 78.5 33.3zM69.2 401.2C121.6 259.9 214.7 224 256 224s134.4 35.9 186.8 177.2c3.6 9.7 5.2 20.1 5.2 30.5l0 1.6c0 25.8-20.9 46.7-46.7 46.7-11.5 0-22.9-1.4-34-4.2l-88-22c-15.3-3.8-31.3-3.8-46.6 0l-88 22c-11.1 2.8-22.5 4.2-34 4.2-25.8 0-46.7-20.9-46.7-46.7l0-1.6c0-10.4 1.6-20.8 5.2-30.5zM421.8 282.7c-24.5-14-29.1-51.7-10.2-84.1s54-47.3 78.5-33.3 29.1 51.7 10.2 84.1-54 47.3-78.5 33.3zM310.1 189.7c-32.3-10.6-46.9-53.9-32.6-96.8s52.1-69.1 84.4-58.5 46.9 53.9 32.6 96.8-52.1 69.1-84.4 58.5z" />
                </svg>Impounded
            </x-responsive-nav-link>
