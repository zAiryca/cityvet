...
<div class="max-w-7xl mx-auto py-6 px-4">
    ...
    <p class="text-gray-700 mb-4">CityVet is a community-driven animal shelter dedicated to reuniting lost pets with owners and finding loving homes for adoptable animals. Our services include impound management, adoption programs, lost & found posters, and educational announcements.</p>
