        ...
        <div class="relative z-10 w-full max-w-md card-container rounded-2xl overflow-hidden">
            ...
            <div class="p-8 lg:p-10 flex flex-col justify-center">
                ...
                <div class="mb-8 text-center fade-transition">
                    <h1 class="text-4xl font-bold text-white mb-3">Forgot Password</h1>
                    <p class="text-slate-300 text-sm">Enter your email to receive a reset link</p>
                </div>
                ...
                <form method="POST" action="{{ route('password.email') }}" class="space-y-4">
                    ...
                    <div class="fade-transition">
                        ...
                        <input id="email" name="email" type="email" required value="{{ old('email') }}"
                               ...
                               placeholder="juandelacruz2@gmail.com" autofocus>
                        @error('email')
