<x-guest-layout>
    ...
    <div class="relative flex-col justify-between hidden p-8 overflow-hidden md:flex md:col-span-1 lg:p-10 bg-gradient-to-br from-green-50 via-white to-green-50">
                ...
                <div class="relative z-10">
                    <div class="flex items-center">
                        ...
                        <div class="ml-2">
                            ...
                            <p class="text-xs tracking-widest uppercase text-gray-500">FindFurEver</p>
                        </div>
                    </div>
                </div>
