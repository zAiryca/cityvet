<x-guest-layout>
    <div class="relative flex min-h-screen overflow-hidden bg-gray-50">
        <div class="relative hidden w-1/2 overflow-hidden lg:block bg-gradient-to-br from-green-400 via-emerald-500 to-teal-600">
                ...
                <div>
                    <div class="flex items-center justify-between">
                        <h3 class="text-lg font-bold leading-6 text-green-700" id="modal-headline">
                            Full Policy: 🐾 City Vet - FindFurEver System
                        </h3>
                    ...
                    <div class="p-2 mt-4 overflow-y-auto text-sm text-gray-600 border rounded-lg max-h-96">
                        ...
                        <h4 class="mt-2 font-bold text-gray-900">I. 🏛️ User-to-Admin / City Vet Interactions</h4>
